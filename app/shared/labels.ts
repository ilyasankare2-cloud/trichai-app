...
export const EXTRA_INFO: Record<LabelKey, ExtraInfo> = {
  bud: {
    ...
    moderation:  'Empieza con poca cantidad y espera 15 min antes de repetir. La paciencia ahorra disgustos.',
    tip:         'El vaporizador conserva mejor los terpenos y daña menos los pulmones que fumar.',
    cbd:         '0.1% — 2%',
  },
  hash: {
    ...
    moderation:  'Esto va fuerte. Si vienes de fumar flor, baja la cantidad a la mitad o menos.',
    tip:         'El marroquí estándar ronda 20-35% THC. El bubble puede pasar del 50%, así que cambia mucho según el tipo.',
    cbd:         '1% — 5%',
  },
  other: {
  ...
  plant: {
    ...
    moderation:  'Es una planta, no producto. El THC todavía no está al máximo.',
    tip:         'En pre-cosecha los tricomas se ven a simple vista — la planta está en su pico de potencia.',
